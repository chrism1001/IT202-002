...
<tr><td> <em>Generated: </em> 2/20/2022 7:57:20 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-002-S22/init-db-setup/grade/cm43" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/58187990/154867386-fecabc9f-6415-4bb0-9943-ce78ef14aafc.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>This screenshot is the table that shows when you visit init_db.php.<br></p>
</td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/58187990/154867446-d8ffdac3-e7b2-48b0-a009-e9bce98425c6.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>This screenshot is from the VS Code extension. It shows the table that<br>was generated.<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>This week I learned about sql. Sql allows us to access and manipulate<br>databases. Sql has many useful functions that allow us to extract data and<br>update data. We can creat tables for information we need and use it<br>for our applications. There are many commands that we can use to get<br>information we need which is quite useful. We can also combine databases to<br>represent data that we need.<br></p><br></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/chrism1001/IT202-002/pull/13">https://github.com/chrism1001/IT202-002/pull/13</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://cm43-prod.herokuapp.com/Project/sql/init_db.php">https://cm43-prod.herokuapp.com/Project/sql/init_db.php</a> </td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-002-S22/init-db-setup/grade/cm43" target="_blank">Grading</a></td></tr></table>